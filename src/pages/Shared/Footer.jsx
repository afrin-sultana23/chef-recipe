...
const Footer = () => {
  return (
    <div>
      <div className='p-10 bg-neutral-700 text-base-content'>
        <div className='px-10 md:px-32 grid grid-cols-1 md:grid-cols-4 place-items-stretch gap-3 text-white'>
          <div className='flex flex-col'>
            <h1 className='text-6xl font-bold text-pink-500'>Food <br /> Feast</h1>
          </div>
          ...
          <div className='flex flex-col md:mt-6 md:place-items-center'>
          ...
          <div className='flex flex-col md:mt-6 md:place-items-end'>
      ...
      <div className='px-10 py-4 border-t bg-neutral-700 text-white border-slate-300'>
        <footer className="footer px-10 md:px-32">
          <div className="items-center grid-flow-col">
            ...
            <p>Food Feast <br />Providing reliable food services since 2023</p>
          </div>
